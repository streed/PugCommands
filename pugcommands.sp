...
public void OnPluginStart()
{
	...
	****************************************************/
	...
	g_ReadyOn.AddChangeHook(Event_ReadyCVarChanged);
	g_RequiredReadies.AddChangeHook(Event_RequiredReadiesChanged);
}
...
public Action Command_NotReady(int client, int args)
{
	...
	if(readyStatus[client])
	{
		...
		CS_SetClientClanTag(client, "[UNREADY]");
	} else if(!readyStatus[client])
	{
